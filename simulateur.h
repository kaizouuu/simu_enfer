...
int moteurSimulation(struct ech *A, struct ppf * pt_tete , struct cours_algo **pt_tete_cours_algo, struct file_poste **pt_tete_file_poste, struct epilation_cheveux **pt_tete_epilation_cheveux, struct marseillais **pt_tete_marseillais, int * ); //Essai FLORENT
