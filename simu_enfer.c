...
int main()
{
    ...
    menu(&pt_tete,nouveau,nomrech,database_PPF,&pt_tete_cours_algo,nouveau_cour_algo,&pt_tete_file_poste,nouveau_file_poste,&pt_tete_epilation_cheveux,&pt_tete_marseillais,nombrerech);
    fclose(database_PPF);
    return 0;
}
